 ...
 * credential at all.
 *
 * Run: node scripts/seed-sql.mjs > seed-places.sql
 */
 ...
 * literal, e.g. "Café" → U&'Caf\00e9'. Postgres decodes it back to real UTF-8 on
 * insert, but the SQL text carries no byte above 0x7e — so it survives any
 * clipboard, terminal, or locale that would otherwise mangle it. (It will:
 * pasting through macOS pbcopy under a locale-less shell reads UTF-8 as MacRoman
 * and turns "í" into "√≠".)
 */
const q = (v) => {
