...
const ES = {
  ...
  "beans.advanced": "Filtros avanzados de grano",
  "beans.cuppingFilter": "Puntaje de cata mínimo",
  "beans.cuppingFilterHint": "Solo muestra lugares con un puntaje publicado que llegue a ese nivel.",
  "beans.sourcingFilterHint": "Solo aplica a tostadores. Incluye modelos mixtos cuando corresponde.",
...
const EN: Record<keyof typeof ES, string> = {
  ...
  "beans.advanced": "Advanced bean filters",
  "beans.cuppingFilter": "Minimum cupping score",
  "beans.cuppingFilterHint": "Only shows places with a published score reaching that level.",
  "beans.sourcingFilterHint": "Roasteries only. Mixed sourcing models match when relevant.",
