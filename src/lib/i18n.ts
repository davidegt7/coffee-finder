...
const ES = {
  ...
  "coffee.program": "¿Espresso o filtrado?",
  "coffee.programHint": "Elige uno o ambos programas de café.",
  "coffee.filterHint": "Puedes elegir Espresso, café filtrado o ambos.",
  "coffee.espressoSetup": "Barra de espresso",
  "coffee.espressoMachine": "Marca de la máquina de espresso",
  "coffee.espressoGrinder": "Marca del molino de espresso",
  "coffee.filterSetup": "Barra de filtrados",
  "coffee.filterGrinder": "Marca del molino para café filtrado",
  "coffee.filterMethods": "Métodos de café filtrado",
  "coffee.brandPlaceholder": "Ej: La Marzocco, Mahlkönig…",
  "beans.program": "Café en grano",
  "beans.roastLevels": "Nivel de tueste",
  "beans.roastHint": "Marca todos los perfiles que normalmente ofrecen.",
  "beans.advanced": "Filtros avanzados de café",
  "beans.bestMatch": "Coincide con todos tus filtros avanzados",
  "beans.cuppingFilter": "Puntaje de cata mínimo",
  "beans.cuppingFilterHint": "Prioriza lugares con un puntaje publicado que llegue a ese nivel.",
  "beans.sourcingFilterHint": "Prioriza tostadores que coincidan. Incluye modelos mixtos cuando corresponde.",
  "beans.formTitle": "Los granos que ofrecen",
  "beans.cuppingTitle": "Rango de puntaje de cata",
  "beans.cuppingMin": "Puntaje más bajo",
  "beans.cuppingMax": "Puntaje más alto",
  "beans.cuppingHint": "Opcional: usa el rango de los cafés que ofrecen actualmente, no un promedio inventado.",
  "beans.scoreRangeError": "El puntaje más bajo no puede superar al más alto.",
  "beans.sourcingTitle": "Cómo compran el café verde",
  "beans.sourcingHint": "Solo para tostadores. Queda registrado como lo que declara el tostador, no como algo comprobado.",
  "beans.publicTitle": "Los granos",
  "beans.upTo": "Hasta",
  "beans.sourcingPublicNote": "El modelo de compra es información declarada por el tostador.",
  ...
  "sheet.coffeeSetup": "La barra de café",
  "sheet.edit": "✎ Editar",
  "sheet.gapNote":
  ...
  "brand.specialty": "Café de especialidad",
  "about.cta": "Sobre nosotros",
  "about.title": "Sobre nosotros",
  "about.intro": "CoffeeFinder es una guía independiente para descubrir cafeterías y tostadores de café de especialidad.",
  "about.specialtyTitle": "Café de especialidad",
  "about.specialtyBody": "Nos enfocamos en lugares que cuidan el café, desde el origen y el tueste hasta la taza.",
  "about.reviewTitle": "Información revisada",
  "about.reviewBody": "Revisamos las solicitudes antes de publicar y distinguimos lo declarado de lo que comprobamos.",
  "about.independentTitle": "Sin anuncios",
  "about.independentBody": "No vendemos posiciones ni filas promocionadas. El mapa está hecho para quienes buscan buen café.",
  ...
  "submit.coffeeTitle": "El café que sirven",
  "submit.coffeeBrand": "Marca de café con la que trabajan",
  "submit.coffeeBrandPlaceholder": "Ej: Coffee Collective, NOMAD, tostado propio…",
  "submit.specialtyQuestion": "¿Es café de especialidad / craft?",
  "submit.specialtyYes": "Sí, especialidad / craft",
  "submit.specialtyNo": "No",
  "submit.coffeePhotoTitle": "Foto del café que usan",
  "submit.coffeePhotoPick": "🫘 Subir foto del café",
  "submit.coffeePhotoAlt": "Foto del café que usa el local",
  "submit.coffeePhotoNote": "Opcional: sube una foto de la bolsa, marca o granos que sirven.",
  "submit.photosTitle": "Fotos del local",
  "submit.photoPick": "📷 Subir fotos",
  "submit.photoAlt": "Foto del local {n}",
  "submit.photoNote": "Puedes subir hasta 3 fotos reales que el local tenga derecho a usar. Las revisamos antes de publicarlas.",
  "submit.note": "Algo más que debamos saber",
  "submit.notePlaceholder": "Horarios, qué tuestan, algo que nos ayude a revisar…",
  "submit.required": "Completa los campos con * y elige Espresso o filtrado si sirves café para tomar.",
  ...
  "queue.offers": "Ofrece:",
  "queue.coffeeBrand": "Trabaja con:",
  "queue.specialty": "Especialidad / craft:",
  "queue.coffeePhoto": "Foto del café:",
  "queue.program": "Programa de café:",
  "queue.espressoSetup": "Espresso — máquina / molino:",
  "queue.filterSetup": "Filtrado — molino / métodos:",
  "queue.roastLevels": "Tuestes:",
  "queue.cuppingScore": "Puntaje de cata:",
  "queue.sourcing": "Compra de café verde:",
...
const EN: Record<keyof typeof ES, string> = {
  ...
  "coffee.program": "Espresso or filter?",
  "coffee.programHint": "Choose one or both coffee programs.",
  "coffee.filterHint": "Choose Espresso, filter coffee, or both.",
  "coffee.espressoSetup": "Espresso bar",
  "coffee.espressoMachine": "Espresso machine brand",
  "coffee.espressoGrinder": "Espresso grinder brand",
  "coffee.filterSetup": "Filter bar",
  "coffee.filterGrinder": "Filter coffee grinder brand",
  "coffee.filterMethods": "Filter coffee methods",
  "coffee.brandPlaceholder": "E.g. La Marzocco, Mahlkönig…",
  "beans.program": "Coffee beans",
  "beans.roastLevels": "Roast level",
  "beans.roastHint": "Select every profile you normally offer.",
  "beans.advanced": "Advanced coffee filters",
  "beans.bestMatch": "Matches all your advanced filters",
  "beans.cuppingFilter": "Minimum cupping score",
  "beans.cuppingFilterHint": "Prioritizes places with a published score reaching that level.",
  "beans.sourcingFilterHint": "Prioritizes matching roasteries. Mixed sourcing models match when relevant.",
  "beans.formTitle": "The beans you offer",
  "beans.cuppingTitle": "Cupping-score range",
  "beans.cuppingMin": "Lowest score",
  "beans.cuppingMax": "Highest score",
  "beans.cuppingHint": "Optional: use the range of coffees currently offered, not an invented average.",
  "beans.scoreRangeError": "The lowest score cannot be higher than the highest score.",
  "beans.sourcingTitle": "How green coffee is sourced",
  "beans.sourcingHint": "Roasteries only. This is recorded as what the roaster states, not as independently verified.",
  "beans.publicTitle": "The beans",
  "beans.upTo": "Up to",
  "beans.sourcingPublicNote": "The sourcing model is information declared by the roaster.",
  ...
  "sheet.coffeeSetup": "The coffee bar",
  "sheet.edit": "✎ Edit",
  "sheet.gapNote":
  ...
  "brand.specialty": "Specialty coffee",
  "about.cta": "About us",
  "about.title": "About us",
  "about.intro": "CoffeeFinder is an independent guide for discovering specialty coffee shops and roasters.",
  "about.specialtyTitle": "Specialty coffee",
  "about.specialtyBody": "We focus on places that care about coffee, from origin and roasting through to the cup.",
  "about.reviewTitle": "Reviewed information",
  "about.reviewBody": "We review requests before publishing and separate what a business states from what we have checked.",
  "about.independentTitle": "No ads",
  "about.independentBody": "We do not sell placement or promoted rows. The map is built for people looking for great coffee.",
  ...
  "submit.coffeeTitle": "The coffee you serve",
  "submit.coffeeBrand": "Coffee brand you work with",
  "submit.coffeeBrandPlaceholder": "E.g. Coffee Collective, NOMAD, roasted in-house…",
  "submit.specialtyQuestion": "Is it specialty / craft coffee?",
  "submit.specialtyYes": "Yes, specialty / craft",
  "submit.specialtyNo": "No",
  "submit.coffeePhotoTitle": "Photo of the coffee you use",
  "submit.coffeePhotoPick": "🫘 Upload coffee photo",
  "submit.coffeePhotoAlt": "Photo of the coffee used by the business",
  "submit.coffeePhotoNote": "Optional: upload a photo of the bag, brand, or beans you serve.",
  "submit.photosTitle": "Photos of the place",
  "submit.photoPick": "📷 Upload photos",
  "submit.photoAlt": "Photo of the place {n}",
  "submit.photoNote": "Upload up to 3 real photos the business has the right to use. We review them before publishing.",
  "submit.note": "Anything else we should know",
  "submit.notePlaceholder": "Hours, what you roast, anything that helps us review…",
  "submit.required": "Complete the * fields and choose Espresso or filter if you serve coffee to drink.",
  ...
  "queue.claims": "States:",
  "queue.offers": "Offers:",
  "queue.coffeeBrand": "Works with:",
  "queue.specialty": "Specialty / craft:",
  "queue.coffeePhoto": "Coffee photo:",
  "queue.program": "Coffee program:",
  "queue.espressoSetup": "Espresso — machine / grinder:",
  "queue.filterSetup": "Filter — grinder / methods:",
  "queue.roastLevels": "Roasts:",
  "queue.cuppingScore": "Cupping score:",
  "queue.sourcing": "Green-coffee sourcing:",
