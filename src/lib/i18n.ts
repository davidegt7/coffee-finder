...
const ES = {
  ...
  "submit.required": "Completa los campos con *: local, dirección, ciudad, país, marca de café, tipo de café y email.",
...
const EN: Record<keyof typeof ES, string> = {
  ...
  "submit.required": "Complete the * fields: place, address, city, country, coffee brand, coffee type, and email.",
